...
/**
 * Handles the creation of table `{{%nearby_places_types}}`.
 */
class m201225_172109_create_nearby_places_types_table extends Migration{
	
	private $nearby_places_types_data = [
		# Table 1
		...
		"night_club",
		"painter", "park", "parking", "pet_store", "pharmacy", "physiotherapist", "plumber", "point_of_interest", "police", "political", "post_office", "primary_school",
		...
		# Table 2
		"administrative_area_level_1", "administrative_area_level_2", "administrative_area_level_3", "administrative_area_level_4", "administrative_area_level_5", "archipelago",
		...
		"place_of_worship", "plus_code", "point_of_interest", "political", "post_box", "postal_code", "postal_code_prefix", "postal_code_suffix", "postal_town", "premise",
		"room", "route",
		"street_address", "street_number", "sublocality", "sublocality_level_1", "sublocality_level_2", "sublocality_level_3", "sublocality_level_4", "sublocality_level_5", "subpremise",
		"town_square",
	...
	public function safeUp(){
		$table = '{{%nearby_places_types}}';
		
		$this->createTable($table, [
			'id'     => $this->primaryKey(),
			'name'   => $this->string(40)->null(),
			'label'   => $this->string(40)->null(),
		...
		$data = array_unique($this->nearby_places_types_data, SORT_STRING);
		sort($data); reset($data);
	...
	public function safeDown(){
		$this->dropTable('{{%nearby_places_types}}');
	}
