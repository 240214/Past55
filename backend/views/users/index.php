...
/* @var $searchModel common\models\search\SearchUsers */
		...
		'columns' => [
			...
			[
				...
				'content'        => function($data){
					...
					$content .= Html::checkbox('active', $data->active, ['data-trigger' => 'js_action_change', 'data-action' => 'ajax_change_user_status', 'value' => $data->id]);
