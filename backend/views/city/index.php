...
/* @var $searchModel common\models\search\SearchCity */
		...
		'columns'      => [
			...
			[
				...
				'content' => function($data) use ($searchModel){
					$value = htmlspecialchars("<?=Url::toRoute(['property/index', 'state' => '".$searchModel->getStates()[$data->state_id]."', 'slug' => '".strtolower($data->name)."']);?>");
