...
<div class="row">
    <div class=" col-lg-12">
        ...
        <div class="chart_wrapper">
            ...
            $cat = Category::find()->limit(15)->all();
            foreach($cat as $data)
            {
                $ads_count = Property::find()->where(['category'=>$data['id']])->count();;
...
<div class="row">
    ...
    <div class="col-md-8">
        ...
        <div class="box box-success">
                        ...
                        <table class="table">
                            ...
                            foreach($statistics as $list)
                            {
                                ...
                                <tr>
                                    ...
                                    <td><?=Track::ExactOs($list['agent']) ; ?></td>
                                    <td><?=Track::ExactBrowserName($list['agent']) ; ?></td>
                                    <td> <?= $list['system']; ?></td>
                                    <td> <?= $list['ip']; ?></td>
            ...
            <div class="box-footer clearfix">
                <a href="<?=Url::toRoute('statics/index');?>" class="btn btn-sm btn-info btn-flat pull-left">View All</a>
            </div><!-- /.box-footer -->
        </div><!-- /.box -->
        ...
        <div class="box box-info">
                    ...
                    <table class="table no-margin">
                        ...
                        foreach($property as $adsList)
                        {
                            ...
                            <tr>
                                ...
                                <td><?= $adsList['title'] ?></td>
                                <td><span class="label label-success"><?= $adsList['status'] ?></span></td>
            ...
            <div class="box-footer clearfix">
                <a href="<?=Url::toRoute('property/index') ?>" class="btn btn-sm btn-info btn-flat pull-left">View All properties</a>
            </div><!-- /.box-footer -->
        </div><!-- /.box -->
    </div><!-- /.col -->
    ...
    <div class="col-md-4">
                ...
                <ul class="users-list clearfix">
                    ...
                    foreach($member as $user)
                    {
                        ...
                        <li>
                            ...
                            <a class="users-list-name" href="<?=Url::toRoute('site/user') ?>?id=<?= $user['id'] ?>"><?= $user['username'] ?></a>
        ...
        <div class="box box-primary">
                    ...
                    foreach($property as $adsList)
                    {
                        ...
                        <li class="item">
                            <div class="product-img">
                                ...
                                <img src="<?= Yii::$app->urlManagerFrontend->baseUrl.'/images/property/cover/'.$img?>" class="img-thumbnail">
                            </div>
            ...
            <div class="box-footer text-center">
                <a href="<?=Url::toRoute('property/index') ?>" class="uppercase">View All properties</a>
            </div><!-- /.box-footer -->
        </div><!-- /.box -->
    </div><!-- /.col -->
</div>