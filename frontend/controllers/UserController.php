...
class UserController extends BaseController {
	...
	public function actionIndex(){
		...
		if($findAgent->load(Yii::$app->request->post())){
			$searchResult = Users::find()->where(['city' => $findAgent->city])->andWhere(['deal_property_type' => $findAgent->deal_property_type])->andWhere(['dealing_in' => $findAgent->dealing_in])->all();
			if($searchResult){
				...
				$searchResult = Users::find()->where(['city' => $findAgent->city])->orWhere(['deal_property_type' => $findAgent->deal_property_type])->orWhere(['dealing_in' => $findAgent->dealing_in])->limit(5)->all();
