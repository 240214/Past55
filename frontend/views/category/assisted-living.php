		...
		<div class="row">
			<div class="col-12 col-md-2 d-none d-md-block">
				<div class="sticky-block top-30">
					...
					<a href="#top" class="article__content-link text-decoration-none mb-1">What is Assisted Living?</a>
					<a href="#care" class="article__content-link text-decoration-none mb-1">What care is provided in assisted living?</a>
					<a href="#accomodations" class="article__content-link text-decoration-none mb-1">What accomodations can I expect in assisted living?</a>
					<a href="#to-do" class="article__content-link text-decoration-none mb-1">What is there to do in assisted living?</a>
					<a href="#not-do" class="article__content-link text-decoration-none mb-1">What assisted living does not do</a>
					<a href="#cost" class="article__content-link text-decoration-none mb-1">Is assisted living free?</a>
					<a href="#philosophy" class="article__content-link text-decoration-none mb-1">Assisted living philosophy</a>
					<a href="#benefits" class="article__content-link text-decoration-none mb-1">Benefits of assisted living</a>
					<?php #=PostContentList::widget(['title' => 'Table of Contents', 'model' => $model]);?>
				</div>
			</div>

			<div class="col-12 col-md-7 text-color-black">
				<h2 class="hub-page__title mb-15">What is Assisted Living?</h2>
