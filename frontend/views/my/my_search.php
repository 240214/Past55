            ...
            <div class="tab-nav tab-nav--justified" data-rmd-breakpoint="650">
                <div class="tab-nav__inner">
                    <ul>
                        ...
                        <li class="active"><a href="<?= \yii\helpers\Url::toRoute('my/search') ?>">My Searches</a></li>
                    ...
                    <div class="list-group__wrap">
                        <a class="list-group-item" href="#">
                            <div class="list-group__text">
                                <b>Keyword:</b> <?= $list['keywords'] ?>,
                                <b>Type:</b> <?= $list['type'] ?>,
                                <b>Property of:</b> <?= $list['property_of'] ?>,
                                <b>List for:</b> <?= $list['list_for'] ?>,
                                <b>Price range:</b>  <?= $list['price_min'] ?> - <?= $list['price_max'] ?>
                                <b>Bedrooms :</b> <?= $list['bedrooms'] ?>,
                                <b>Bathrooms :</b> <?= $list['bathrooms'] ?>,


                                <small><?= date('d/m/Y',$list['search_time']); ?> at <?= date('h:i:A',$list['search_time']); ?></small>
                            </div>
                        </a>

                        <div class="actions list-group__actions hidden">
                            <div class="dropdown">
