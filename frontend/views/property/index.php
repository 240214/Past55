...
$this->registerCssFile('@web/theme/css/category.css?v='.YII_CSS_VERS, ['depends' => [BootstrapAsset::className(), AppAsset::className()]]);
		...
		<div class="row mb-3">
			...
			<div class="col-12 col-md-8">
				...
				<div class="category__body">
					<div id="js_filter_results" class="row property-listing trans-all <?=(!$items_count ? 'no-results' : '');?>">
						<?php if($items_count):?>
							<?=$this->render('partials/items', ['models' => $item_models, 'options' => $options]);?>
						<?php else:?>
							<div class="card box">
